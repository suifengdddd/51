...
main()
{
   ...
   //11111111111111111111111111111111 int i=1;
...
//		 if(c51_key.key/8==0&&c51_key.key%8==0)
//		 { 
//			  c51_led.led_all_off();
//		 }
		 c51_led.led_flicker(1,100);
		 c51_led.led_flicker(2,100);
//		c51_nixie_tube.dynamic_display(1,6,c51_nixie_tube.arr);
